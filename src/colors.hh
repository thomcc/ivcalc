...
#define BLACK(S) FG_BLACK S COL_RESET
#define RED(S) FG_RED S COL_RESET
#define GREEN(S) FG_GREEN S COL_RESET
#define YELLOW(S) FG_YELLOW S COL_RESET
#define BLUE(S) FG_BLUE S COL_RESET
#define MAGENTA(S) FG_MAGENTA S COL_RESET
#define CYAN(S) FG_CYAN S COL_RESET
#define WHITE(S) FG_WHITE S COL_RESET
#define DEFAULT(S) FG_DEFAULT S COL_RESET
